 ...
 * @date 2014-6-9
 */
public class UninstalledAppInfoHandler {
	 ...
	 * @return
	 */
	public static APKFileInfo getUninstalledApkFileInfo(Context context,
			String apkFilePath) {
		File apkFile = new File(apkFilePath);
		if (!apkFile.exists()) {
			System.out
					.println("getUninstalledApkFileInfo....file path is not correct");
			return null;
		}
		...
		try {
			...
			valueArgs = new Object[] { new File(apkFilePath), apkFilePath,
					metrics, 0 };
